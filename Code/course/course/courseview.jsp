...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="780" height="69" valign="bottom" background="images/header.gif"><div align="center" class="style14">AVAILABLE COURSES AND BRANCHES IN THE COLLEGE</div></td>
  </tr>
  <tr>
    ...
    <%   }%>
                    ...
                    <tr>
                      <td height="81" valign="top" background="ch.JPG" bgcolor="#8AB06B"><div align="center">
                        ...
                        <TABLE align="center">
        <TR>
            <TD><form ACTION="coursefullview.jsp" method="post" >
            <button type="submit">FOR COMPLETE INFORMATION</button>
            </form>
            </TD>
        </TR>
    </TABLE>
