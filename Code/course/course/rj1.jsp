...
PreparedStatement pst3 = con.prepareStatement("select subcode from addsub where (cname=? and creg=?)");
pst3.setString(1, c);
pst3.setString(2, cr);
...
PreparedStatement pst = con.prepareStatement("DELETE from courseinfo where cname=? and creg=?");
pst.setString(1, c);
pst.setString(2, cr);
int num=pst.executeUpdate();
PreparedStatement pst1 = con.prepareStatement("DELETE from addsub where cname=? and creg=?");
pst1.setString(1, c);
pst1.setString(2, cr);
...
<table width="778" height="404" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="780" height="69" valign="bottom" background="images/header.gif"><div align="center" class="style14">
      <DIV align="center">Deleting a particular Course </DIV>
    </div></td>
  </tr>
  <tr>
            ...
            <td width="764" bgcolor="#CCCCCC"><table width="749" height="207" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><p align="center">&nbsp;</p>
                    <center>
                      <p class="style25">&nbsp;</p>
                      <span class="style26 style25"><span class="style25"><%= request.getParameter("cnm")%> Course on Regulation <%= request.getParameter("creg")%> doesnot exist in Database                      </span></span>
                    </center>
...
<TABLE align="center">
        <TR>
            <TD><form ACTION="r1.jsp" method="post" >
