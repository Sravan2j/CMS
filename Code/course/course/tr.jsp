...
<body>
    ...
    <form name="syv1" method="post" action="trail1.jsp" onSubmit="return f1()">
                      ...
                      <td height="81" valign="top" background="ch.JPG" bgcolor="#8AB06B"><div align="center">
                       ...
                       <table width="200" border="0">
                          <tr>
                            ...
                            <td width="100" align="center"><form action="courses.html"><input type="submit" value="Back"></form></td>
                          </tr>
                        </table>
                        <p>&nbsp;</p>
                      </div></td>
