...
<script>function f1(){
if(document.remove2.cnm.value==0)
	{
        alert("please select course");
		return false;
    }
    if((document.remove2.cnm.value=='B.Tech')&(document.remove2.bch.value=='-'))
	{
        alert("please select Branch");
		return false;
    }
 if(document.remove2.creg.value==0)
	{
...
%>
<form name="remove2" method="post" action="rj2.jsp" onSubmit="return f1()">
  <table width="778" height="317" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="780" height="69" valign="bottom" background="images/header.gif"><div align="center"><span class="style2">Deleting a particular Branch </span></div></td>
  </tr>
  <tr>
            ...
            <td width="764" bgcolor="#CCCCCC"><table width="749" height="207" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><p>&nbsp;</p>
                    <table width="300" border="0" align="center" cellpadding="15" cellspacing="0">
                      <%
