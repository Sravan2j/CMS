...
if(document.sbv1.cname.value==0)
    ...
    else if(document.sbv1.sem.value=='-'){
...
<form name="sbv1" method="post" action="retrive3.jsp" onSubmit="return f1()">
                      ...
                      <td height="81" valign="top" background="ch.JPG" bgcolor="#8AB06B"><div align="center">
					   ...
					   <table width="200" border="0">
                          <tr>
                            ...
                            <td width="100" align="center"><form action="viewc.html"><input type="submit" value="Back"></form></td>
                          </tr>
                        </table>
