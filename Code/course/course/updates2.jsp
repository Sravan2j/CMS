...
<script>function f1(){
if(document.update1.cname.value==0)
	{
        alert("please select course");
		return false;
    }
     if((document.update1.cname.value=='B.Tech')&(document.update1.bname.value=='-'))
	{
        alert("please select Branch");
		return false;
    }
    if(document.update1.creg.value==0)
	{
        alert("please select Course Regulation");
		return false;
    }
if(document.update1.year.value==0)
	{
        alert("please select year");
		return false;
    }
 if(document.update1.subname.value=="-")
	{
...
<table width="778" height="404" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="780" height="69" valign="bottom" background="images/header.gif"><div align="center" class="style14"><span class="style1">Select Options To Update</span></div></td>
  </tr>
  <tr>
			...
			<option value=- selected=selected>-- -- -- -- -- --</option>
                    ...
                    <tr>
                      ...
                      <table width="200" border="0">
                          <tr>
                            <td width="100" align="center" valign="top"> <input type="submit" name="Submit" value="Ok" /></form></td>
...
function popu()
{
	...
	var cname = document.update1.cname.value;
	var bname = document.update1.bname.value;
	var creg = document.update1.creg.value;
	var year = document.update1.year.value;
	
if((document.update1.cname.value=='B.Tech')&(document.update1.year.value=='I'))
	{
       var sem="-";
    }
    else
       {
           var sem = document.update1.sem.value;
       }
